...
const dyscrollup = {
    ...
    animate: function () {
        ...
        // Get the button
        let btn = document.getElementById(self.btnID);
        ...
        let intervalTimeout = self.option.scrolldelay / divider;

        // Compute the distance to travel for each N parts
        let travel = Number((distance * intervalTimeout) / self.option.scrolldelay);
        ...
        // Set the interval
        let intervalfn = setInterval(scrollUpdate, intervalTimeout);
